...
- C# / .NET 8.0 LTS (ASP.NET Core MVC) + QRCoder 1.6.x, SixLabors.ImageSharp 3.x, Azure.Storage.Blobs (008-contact-upload-open-existing)
- Azure Blob Storage (JSON documents in a single container) (008-contact-upload-open-existing)
...
## Recent Changes
- 008-contact-upload-open-existing: Added C# / .NET 8.0 LTS (ASP.NET Core MVC) + QRCoder 1.6.x, SixLabors.ImageSharp 3.x, Azure.Storage.Blobs
