...
- 002-vcf-contact-qr: Added C# / .NET 8.0 (ASP.NET Core MVC); Vanilla JavaScript ES2020+; CSS3 + QRCoder 1.6.0, SixLabors.ImageSharp 3.1.12, SixLabors.ImageSharp.Drawing 2.1.7

- 001-ui-rebrand-share: Added C# / .NET 8.0 (ASP.NET Core MVC); Vanilla JavaScript ES2020+; CSS3 + QRCoder 1.6.0, SixLabors.ImageSharp 3.1.12, SixLabors.ImageSharp.Drawing 2.1.7
